...
NEXNOTATIONDOC = {
    ...
    'fA.radians':{'name':"Float as Radian.",'desc':"Return a converted SocketFloat value to radians.\nRead-only property."},
    'fA.degrees':{'name':"Float as Degree.",'desc':"Return a converted SocketFloat value to degrees.\nRead-only property."},
    'fA.rounded':{'name':"Float Round Operation.",'desc':"Return a rounded SocketFloat value.\nRead-only property."},
