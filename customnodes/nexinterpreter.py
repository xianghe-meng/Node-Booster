...
NEXNOTATIONDOC = {
    ...
    'fA.as_radians()':{'name':"to Radian.",'desc':"Return a converted SocketFloat value to radians."},
    'fA.as_degrees()':{'name':"to Degree.",'desc':"Return a converted SocketFloat value to degrees."},
    'fA.round()':{'name':"Round Operation.",'desc':"Return a rounded SocketFloat value."},
    'fA.floor()':{'name':"Floor Operation.",'desc':"Return a floored SocketFloat value."},
    'fA.ceil()':{'name':"Ceil Operation.",'desc':"Return a ceiled SocketFloat value."},
    'fA.trunc()':{'name':"Truncate Operation.",'desc':"Return a truncated SocketFloat value."},
    'vecA.x':{'name':"Get X.",'desc':"Get or Assign a SocketFloat value from the X axis of a SocketVector.\nIs equivalent to the 'vecA[0]' notation."},
    'vecA.y':{'name':"Get Y.",'desc':"Get or Assign a SocketFloat value from the Y axis of a SocketVector.\nIs equivalent to the 'vecA[1]' notation."},
